...
export default function ExplainerDashboardPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col px-6 py-12 sm:px-10">
      ...
      <nav aria-label="Secciones del espacio de trabajo" className="order-0 mb-10 grid gap-2 sm:grid-cols-3">
      ...
      <section id="review" className="order-3 mb-8 scroll-mt-8">
      ...
      <section id="create" className="order-4 mb-12 scroll-mt-8">
        <details className="group border border-core-border/[0.12] bg-core-panel/40">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-5 py-4 [&::-webkit-details-marker]:hidden">
            <span>
      ...
      <section id="explore" aria-labelledby="explore-heading" className="order-2 scroll-mt-8">

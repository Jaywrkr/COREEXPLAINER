...
export const instanaMeta: ExplainerMeta = {
  targetArchitecture: {
    ...
    roadmap: [
      { id: "coverage", title: "Mapear cobertura", objective: "Identificar servicios, dependencias y señales prioritarias.", evidence: "Inventario, mapa, agentes/sensores, tags y señales recibidas.", exitCriteria: "Las rutas prioritarias tienen cobertura y dueño operativo.", sourceIds: ["instana-capabilities", "instana-fullstack"] },
      { id: "correlate", title: "Correlacionar evidencia", objective: "Conectar trazas, métricas, logs y cambios con preguntas de incidente.", evidence: "Casos representativos, dependencias, retención y calidad de señal.", exitCriteria: "El equipo puede explicar qué evidencia sostiene una hipótesis.", sourceIds: ["instana-apm", "instana-investigation"] },
      { id: "operate", title: "Operar con control", objective: "Definir investigación, remediación, permisos y criterios de éxito.", evidence: "Runbook, aprobaciones, límites de automatización y prueba funcional.", exitCriteria: "La remediación queda gobernada y medible.", sourceIds: ["instana-investigation", "instana-deployment"] },
    ],
    decisionOptions: [
      { id: "coverage-first", title: "Priorizar cobertura", summary: "Cubrir primero servicios y dependencias críticas.", benefits: "Reduce zonas ciegas y mejora la calidad del contexto durante incidentes.", tradeoffs: "Requiere inventario, agentes, sensores, permisos y gobierno de datos antes de prometer resultados.", evidence: "Mapa de servicios, porcentaje de cobertura, señales recibidas y dependencias prioritarias.", sourceIds: ["instana-capabilities", "instana-fullstack"], roadmapPhaseIds: ["coverage"], scenarioIds: ["instrumentation-gap", "topology-drift"] },
      { id: "investigation-first", title: "Priorizar investigación", summary: "Optimizar la correlación de señales y cambios para reducir el tiempo de diagnóstico.", benefits: "Ayuda a enfocar la respuesta en impacto y causa probable, con contexto compartido.", tradeoffs: "Una hipótesis seguirá siendo débil si la cobertura, retención o calidad de señales es insuficiente.", evidence: "Casos de incidente, trazas, métricas, logs, cambios y criterio de remediación.", sourceIds: ["instana-investigation", "instana-apm"], roadmapPhaseIds: ["correlate", "operate"], scenarioIds: ["false-cause", "telemetry-pipeline"] },
    ],
  },

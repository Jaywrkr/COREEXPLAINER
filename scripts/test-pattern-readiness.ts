...
const ready = assessPatternReadiness(pattern, pattern.explainerSlugs.map((slug) => ({ slug, exists: true, reviewStatus: "reviewed", allSourcesCurrent: true, warningCount: 0 })));

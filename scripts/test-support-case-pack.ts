...
const markdown = buildSupportCaseMarkdown({ slug: "tema", title: meta.title, appVersion: "0.149.0", generatedAt: "2026-08-11T00:00:00.000Z", brands: ["IBM"], draft: { ...draft, selectedTriageId: "scenario:s1" }, triage });

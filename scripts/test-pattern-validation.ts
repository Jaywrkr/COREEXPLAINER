...
assert.deepEqual(validateSolutionPatterns(solutionPatterns, new Set(["vcf", "vsphere-ha", "vsan", "instana", "turbonomic", "observability", "webmethods", "nsx", "zero-trust", "ransomware-resilience", "backup-dr", "veeam-protection", "lan-san", "san-storage", "active-active-dc"])), []);

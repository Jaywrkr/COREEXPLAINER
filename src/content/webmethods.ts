...
export const webMethodsMeta: ExplainerMeta = {
  targetArchitecture: {
    ...
    roadmap: [
      { id: "contracts", title: "Definir contratos", objective: "Alinear APIs, mapping, errores, identidad y ownership.", evidence: "Especificaciones, políticas, consumidores, versionado y casos de error.", exitCriteria: "Cada interfaz prioritaria tiene contrato y responsable.", sourceIds: ["wm-gateway", "wm-services"] },
      { id: "runtime", title: "Ubicar runtimes", objective: "Decidir qué se ejecuta en cloud o cerca de los sistemas y datos.", evidence: "Conectividad, VPE/VPN, soberanía, credenciales y dependencias.", exitCriteria: "La topología híbrida tiene rutas y operación definida.", sourceIds: ["wm-architecture", "wm-overview"] },
      { id: "operate", title: "Operar y gobernar", objective: "Validar interoperabilidad, seguridad, observabilidad y soporte.", evidence: "Matriz de releases, logs, ownership, pruebas de contrato y rollback.", exitCriteria: "El flujo puede operar con controles y aceptación de negocio.", sourceIds: ["wm-interoperability", "wm-gateway-components"] },
    ],
    decisionOptions: [
      { id: "api-first", title: "Priorizar APIs y gobierno", summary: "Establecer contratos, seguridad, cuotas y ownership antes de ampliar integraciones.", benefits: "Reduce interfaces opacas y hace operable el consumo de servicios.", tradeoffs: "Puede exigir trabajo de versionado, mapping y adaptación de consumidores existentes.", evidence: "Contratos, políticas, identidad, rate limits, errores y portal de publicación.", sourceIds: ["wm-gateway", "wm-gateway-components"], roadmapPhaseIds: ["contracts", "operate"], scenarioIds: ["api-policy", "mapping-error"] },
      { id: "hybrid-first", title: "Priorizar patrón híbrido", summary: "Definir dónde se ejecuta cada runtime según datos, conectividad y operación.", benefits: "Permite modernizar sin mover todo al mismo lugar y respeta dependencias de sistemas existentes.", tradeoffs: "Aumenta la importancia de conectividad, credenciales, interoperabilidad y observabilidad entre dominios.", evidence: "Matriz de ubicación, rutas, VPE/VPN, versiones y ownership operativo.", sourceIds: ["wm-architecture", "wm-interoperability"], roadmapPhaseIds: ["runtime", "operate"], scenarioIds: ["runtime-unavailable", "version-mismatch"] },
    ],
  },
  ...
  technicalReview: {
    ...
    scope: "Patrón conceptual revisado con IBM webMethods Hybrid Integration y productos 11.1: Integration Server, API Gateway, Developer Portal, hybrid control plane y runtimes remotos; confirmar edición, región, conectores, interoperabilidad, seguridad y patrón de despliegue. La disponibilidad de API Gateway/Developer Portal para un SaaS nuevo debe confirmarse con la guía vigente de IBM.",
    sources: [
      ...
      { id: "wm-whats-new", title: "IBM webMethods Hybrid Integration: what's new", url: "https://www.ibm.com/docs/en/hybrid-integration-lib/hybrid-integration/saas?topic=whats-new", accessedAt: "2026-08-12" },
    ],
  },
